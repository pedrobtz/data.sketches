...
- [`kll_doubles()`](https://pedrobtz.github.io/data.sketches/dev/reference/kll_doubles.md),
  [`kll_floats()`](https://pedrobtz.github.io/data.sketches/dev/reference/kll_floats.md)
  – Karnin-Lang-Liberty (KLL) sketches.
- [`req()`](https://pedrobtz.github.io/data.sketches/dev/reference/req.md)
  – Relative Error Quantiles (REQ), accurate near one tail.
- [`tdigest_double()`](https://pedrobtz.github.io/data.sketches/dev/reference/tdigest_double.md)
  – t-Digest, accurate near both tails.

**Cardinality sketches** for approximate distinct counting:

- [`hll()`](https://pedrobtz.github.io/data.sketches/dev/reference/hll.md)
  – HyperLogLog (HLL).
- [`cpc()`](https://pedrobtz.github.io/data.sketches/dev/reference/cpc.md)
  – Compressed Probabilistic Counting (CPC).
- [`theta()`](https://pedrobtz.github.io/data.sketches/dev/reference/theta.md)
  – Theta, with set operations
  [`theta_union()`](https://pedrobtz.github.io/data.sketches/dev/reference/theta_set_operations.md),
  [`theta_intersection()`](https://pedrobtz.github.io/data.sketches/dev/reference/theta_set_operations.md),
  [`theta_difference()`](https://pedrobtz.github.io/data.sketches/dev/reference/theta_set_operations.md),
  and
  [`theta_jaccard()`](https://pedrobtz.github.io/data.sketches/dev/reference/theta_set_operations.md).
...
- [`array_of_doubles()`](https://pedrobtz.github.io/data.sketches/dev/reference/array_of_doubles.md)
  – Array of Doubles, with set operations
  [`array_of_doubles_union()`](https://pedrobtz.github.io/data.sketches/dev/reference/array_of_doubles_set_operations.md),
  [`array_of_doubles_intersection()`](https://pedrobtz.github.io/data.sketches/dev/reference/array_of_doubles_set_operations.md),
  and
  [`array_of_doubles_difference()`](https://pedrobtz.github.io/data.sketches/dev/reference/array_of_doubles_set_operations.md).
